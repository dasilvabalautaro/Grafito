...
def main():
    ...
    if args.dataset_name is not None:
        # Downloading and loading a dataset from the hub, or from a local DatasetDict saved with save_to_disk.
        dataset_path = Path(args.dataset_name)
        if dataset_path.exists() and (dataset_path / "dataset_dict.json").is_file():
